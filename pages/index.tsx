              ...
              <div className="scroll-animate" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', marginTop: '40px' }}>
                ...
                <Link
                  ...
                  style={{
                    ...
                    transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                    transform: 'translateY(0)',
                    boxShadow: '0 10px 30px rgba(225, 48, 108, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-3px) scale(1.02)';
                    e.currentTarget.style.boxShadow = '0 20px 50px rgba(225, 48, 108, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.3)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'translateY(0) scale(1)';
                    e.currentTarget.style.boxShadow = '0 10px 30px rgba(225, 48, 108, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2)';
                  }}
                >
                  ...
                  <span>watch the reels I make too</span>
                </Link>
              </div>
            </div>
          </div>
